...
(cl:defmethod cl:initialize-instance :after ((m <chapter2_srv1-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'chapter2_srv1-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CDIO-srv:<chapter2_srv1-request> is deprecated: use CDIO-srv:chapter2_srv1-request instead.")))

(cl:ensure-generic-function 'A-val :lambda-list '(m))
(cl:defmethod A-val ((m <chapter2_srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CDIO-srv:A-val is deprecated.  Use CDIO-srv:A instead.")
  (A m))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <chapter2_srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CDIO-srv:B-val is deprecated.  Use CDIO-srv:B instead.")
  (B m))

(cl:ensure-generic-function 'C-val :lambda-list '(m))
(cl:defmethod C-val ((m <chapter2_srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CDIO-srv:C-val is deprecated.  Use CDIO-srv:C instead.")
  (C m))
...
(cl:defmethod cl:initialize-instance :after ((m <chapter2_srv1-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'chapter2_srv1-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CDIO-srv:<chapter2_srv1-response> is deprecated: use CDIO-srv:chapter2_srv1-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <chapter2_srv1-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CDIO-srv:sum-val is deprecated.  Use CDIO-srv:sum instead.")
  (sum m))
