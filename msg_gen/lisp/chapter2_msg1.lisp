...
(cl:defmethod cl:initialize-instance :after ((m <chapter2_msg1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'chapter2_msg1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name CDIO-msg:<chapter2_msg1> is deprecated: use CDIO-msg:chapter2_msg1 instead.")))

(cl:ensure-generic-function 'A-val :lambda-list '(m))
(cl:defmethod A-val ((m <chapter2_msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CDIO-msg:A-val is deprecated.  Use CDIO-msg:A instead.")
  (A m))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <chapter2_msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CDIO-msg:B-val is deprecated.  Use CDIO-msg:B instead.")
  (B m))

(cl:ensure-generic-function 'C-val :lambda-list '(m))
(cl:defmethod C-val ((m <chapter2_msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader CDIO-msg:C-val is deprecated.  Use CDIO-msg:C instead.")
  (C m))
